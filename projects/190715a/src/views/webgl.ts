...
import MainObject from './webgl-objects/main-object'
...
class WebGL {
  ...
  setVideoObject(id: string, $video: HTMLVideoElement): WebGL {
    const _object = this._objects[id]
    _object.setVideo($video)
    return this
  }
